...
int validation::validatePawn(Tile *temp)
{
    ...
    if(temp->pieceColor)
    {
        ...
        {
            explore[max++]=tile[row-1][col]->tileNum;
            retVal=1;
        }

        if(row==6 && !tile[5][col]->piece && !tile[4][col]->piece)
        {
            explore[max++]=tile[row-2][col]->tileNum;
            retVal=1;
        }
        ...
        if(row-1>=0 && col-1>=0)
        {
            ...
            {
            explore[max++]=tile[row-1][col-1]->tileNum;
            retVal=1;
            }
        }
...
int validation::validateHorse(Tile *temp)
{
    ...
    if(r-2>=0 && c-1>=0)
    {
        ...
        {
            explore[max++]=tile[r-2][c-1]->tileNum;
            retVal=1;
        }
    }
    ...
    if(r-1>=0 && c-2>=0)
    {
        ...
        {
            explore[max++]=tile[r-1][c-2]->tileNum;
            retVal=1;
        }
    }
...
int validation::validateKing(Tile *temp)
{
    ...
    if(r-1>=0)
    {
        ...
        {
            explore[max++]=tile[r-1][c]->tileNum;
            retVal=1;
        }
    }
    ...
    if(c-1>=0)
    {
        ...
        {
            explore[max++]=tile[r][c-1]->tileNum;
            retVal=1;
        }
    }
    ...
    if(r-1>=0 && c-1>=0)
    {
        ...
        {
            explore[max++]=tile[r-1][c-1]->tileNum;
            retVal=1;
        }
    }
...
void validation::orange()
{
    ...
    for(i=0;i<max;i++)
        tile[explore[i]/8][explore[i]%8]->setStyleSheet("QLabel {background-color: orange;}");
}
